...
E2Helper.Descriptions["laserGetDataLengthBeam(e:n)"]        = "Returns the laser source beam length"
E2Helper.Descriptions["laserGetDataLengthOrig(e:n)"]        = "Returns the laser source beam length"
...
E2Helper.Descriptions["laserGetDataWaveLength(e:n)"]        = "Returns the laser beam wavelength"
E2Helper.Descriptions["laserGetDataIsDisperse(e:n)"]        = "Returns the laser beam dispersion enable flag"
E2Helper.Descriptions["laserGetDataIsFresnel(e:n)"]         = "Returns the laser beam fresnel enable flag"
E2Helper.Descriptions["laserGetDataFresnelCount(e:n)"]      = "Returns the laser beam fresnel recursion count"
E2Helper.Descriptions["laserGetDataIsNoOver(e:n)"]          = "Returns the laser beam no override material flag"
E2Helper.Descriptions["laserGetDataGravitySize(e:n)"]       = "Returns the laser beam black hole step configuration delta"
E2Helper.Descriptions["laserGetDataGravityStep(e:n)"]       = "Returns the laser beam black hole step configuration used"
-- Wiremod dedicated entity method to retrieve beam trace from hit reports
...
E2Helper.Descriptions["laserGetDissolveID(s)"]              = "Returns the dissolve ID for the corresponding dissolve type"
...
E2Helper.Descriptions["laserGetRefractIsNext()"]            = "Returns the flag indicating beam exits the medium after being refracted"
E2Helper.Descriptions["laserGetRefractIsSame()"]            = "Returns the flag indicating same refraction indices arguments are present"
E2Helper.Descriptions["laserGetRefractCosine()"]            = "Returns the cosine of the angle between the incident and normal vectors"
E2Helper.Descriptions["laserGetRefractAngleRad(nn)"]        = "Returns the interface critical angle between two media in radians"
E2Helper.Descriptions["laserGetRefractAngleDeg(nn)"]        = "Returns the interface critical angle between two media in degrees"
E2Helper.Descriptions["laserGetRefractAngleRatio(nn)"]      = "Returns the interface critical angle relative index between two media"
